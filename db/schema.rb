...
ActiveRecord::Schema.define(version: 20140731211305) do
  ...
  add_index "dragon_rental_requests", ["dragon_id"], name: "index_dragon_rental_requests_on_dragon_id", using: :btree
  add_index "dragon_rental_requests", ["user_id"], name: "index_dragon_rental_requests_on_user_id", using: :btree
